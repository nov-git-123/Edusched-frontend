...
// import "../styles/DeanLayout.css"; // ✅ reuse same CSS for consistent design
...
//       "/admin/subjects": "Subjects & Courses",
//       "/admin/rooms": "Rooms",
...
//             <NavLink end to="/admin/dashboard" className={({ isActive }) => (isActive ? "nav-link-custom active" : "nav-link-custom")}>
//               <FaTachometerAlt /> Dashboard
//             </NavLink>
//           </li>

//           <li className="nav-item mb-2">
//             <NavLink end to="/admin/users" className={({ isActive }) => (isActive ? "nav-link-custom active" : "nav-link-custom")}>
//               <FaUsers /> User Management
//             </NavLink>
//           </li>

//           <li className="nav-item mb-2">
//             <NavLink end to="/admin/instructors" className={({ isActive }) => (isActive ? "nav-link-custom active" : "nav-link-custom")}>
//               <FaChalkboardTeacher /> Instructors
//             </NavLink>
//           </li>

//           <li className="nav-item mb-2">
//             <NavLink end to="/admin/students" className={({ isActive }) => (isActive ? "nav-link-custom active" : "nav-link-custom")}>
//               <FaUsers /> Students
//             </NavLink>
//           </li>

//           <li className="nav-item mb-2">
//             <NavLink end to="/admin/subjects" className={({ isActive }) => (isActive ? "nav-link-custom active" : "nav-link-custom")}>
//               <FaBook /> Subjects & Courses
//             </NavLink>
//           </li>

//           <li className="nav-item mb-2">
//             <NavLink end to="/admin/rooms" className={({ isActive }) => (isActive ? "nav-link-custom active" : "nav-link-custom")}>
//               <MdMeetingRoom /> Rooms
//             </NavLink>
//           </li>

//           <li className="nav-item mb-2">
//             <NavLink end to="/admin/schedules" className={({ isActive }) => (isActive ? "nav-link-custom active" : "nav-link-custom")}>
//               <MdAssessment /> Schedules
//             </NavLink>
//           </li>

//           <li className="nav-item mb-2">
//             <NavLink end to="/admin/roles" className={({ isActive }) => (isActive ? "nav-link-custom active" : "nav-link-custom")}>
//               <FaUserShield /> Roles & Permissions
//             </NavLink>
//           </li>

//           <li className="nav-item mb-2">
//             <NavLink end to="/admin/reports" className={({ isActive }) => (isActive ? "nav-link-custom active" : "nav-link-custom")}>
//               <MdAssessment /> Reports / Logs
//             </NavLink>
//           </li>

//           <li className="nav-item mb-2">
//             <NavLink end to="/admin/settings" className={({ isActive }) => (isActive ? "nav-link-custom active" : "nav-link-custom")}>
...
//             <span className="me-3 fw-bold dean-topbar-name">Admin</span>
//             <img
...
//   Building, Calendar, Shield, FileText, Settings, LogOut, 
//   Menu, X, ChevronRight, Search, Bell, User, ChevronDown
// } from "lucide-react";
...
//       >
//         <img
//           src={user?.photoURL || "/images/superadmin.png"}
//           alt="Profile"
...
//       "/admin/profile": "Profile Settings",
//     };
//     return titleMap[location.pathname] || "Admin Portal";
//   }, [location.pathname]);
...
//               <img src="/images/eslogo.png" alt="EduSched" className="logo" />
//               <button 
//                 className="close-btn"
//                 onClick={() => setMobileSidebarOpen(false)}
//               >
...
const UserDropdown = React.memo(({ user, onLogout }) => {
  ...
  const getPhotoURL = () => {
    if (user?.photoURL) {
      // If photoURL starts with /uploads, prepend the base URL
      if (user.photoURL.startsWith('/uploads')) {
        return `${API_BASE_URL.replace('/api', '')}${user.photoURL}`;
      }
      return user.photoURL;
    }
    return "/images/superadmin.png";
  };
    ...
    <div className="user-dropdown-container">
      ...
      >
        <img
          ...
          className="user-avatar"
          onError={(e) => {
            e.target.src = "/images/superadmin.png";
          }}
        />
        <div className="user-info">
          <span className="user-name">{user?.displayName || user?.full_name || "Admin"}</span>
          <span className="user-role">
            {user?.role === 'dean' ? 'Dean' : 'System Administrator'}
          </span>
        </div>
        <ChevronDown size={16} className={`dropdown-icon ${isOpen ? 'open' : ''}`} />
      </button>
