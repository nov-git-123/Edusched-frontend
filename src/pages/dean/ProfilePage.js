...
// import { auth, storage } from "../firebase"; // your firebase config
...
//             <img
//               src={photoFile ? URL.createObjectURL(photoFile) : currentUser.photoURL || "/images/dean-avatar.png"}
//               alt="Profile"
...
//             setMessage("⚠️ Please log out and log in again before changing your password.");
//           } else {
