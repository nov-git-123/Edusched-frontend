...
//WORKING BUT THE OTHER INSTRUCTORS CANT CHANGE PROFILE
...
//             <div className="photo-section">
//               <ProfilePhotoUploader
//                 currentPhotoURL={currentUser?.photoURL || currentUser?.profile_picture}
//                 photoFile={photoFile}
//                 onPhotoChange={handlePhotoChange}
//                 onPhotoRemove={handlePhotoRemove}
//               />
...
export default function InstructorProfile() {
  ...
  const performUpdate = async () => {
    ...
    try {
      ...
      // CRITICAL FIX: Append the file LAST so Multer parses text fields correctly
      if (photoFile) {
        formData.append('profilePhoto', photoFile);
      }
      ...
      console.log('FormData contents:');
      for (let pair of formData.entries()) {
        console.log(pair[0] + ': ' + (pair[0] === 'profilePhoto' ? pair[1].name : pair[1]));
      }
