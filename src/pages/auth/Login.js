...
//WORKING BUT WITH CONTINUE WITH GOOGLE PROBLEM
...
const RoleSelectionModal = React.memo(({ 
  ...
  const roles = [
    { value: 'dean', label: 'Dean', description: 'Faculty management', disabled: deanExists },
    { value: 'instructor', label: 'Instructor', description: 'Teaching access', disabled: false },
  ];
...
export default function Login() {
  ...
  const handleSaveRole = async (selectedRole) => {
    ...
    // FIXED: Check if dean role is selected when dean already exists
